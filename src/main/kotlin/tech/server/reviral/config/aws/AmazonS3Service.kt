package tech.server.reviral.config.aws
...
class AmazonS3Service constructor(
    ...
    fun uploadMultipartFile(file: MultipartFile, path: String): tech.server.reviral.config.aws.UploadFile {
        ...
        return tech.server.reviral.config.aws.UploadFile(
